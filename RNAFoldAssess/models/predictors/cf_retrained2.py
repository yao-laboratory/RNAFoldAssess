...
class ContraRetrained2:
    def __init__(self):
        self.output = ""

    def execute(self, contra_path, seq_file, remove_file_when_done=False):
        exec_string = f"{contra_path}/src/contrafold predict {seq_file} --params /work/yesselmanlab/ewhiting/data/bprna/retrain_small2/optimize.params.iter27"
