...
ch_1_seq_loc = chromosome_map["chromosome_1"]["seq"]
ch_1_json_loc = chromosome_map["chromosome_1"]["json"]
...
f = open(f"/common/yesselmanlab/ewhiting/data/rasp_data/loc_info.txt", "w") # new
