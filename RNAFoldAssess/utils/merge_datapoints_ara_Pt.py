...
# For testing
exon_locs_raw = {}
ch_1_coord_loc = chromosome_map["chromosome_Pt"]["coords"]
ch_1_seq_loc = chromosome_map["chromosome_Pt"]["seq"]
ch_1_json_loc = chromosome_map["chromosome_Pt"]["json"]
...
f = open(f"/common/yesselmanlab/ewhiting/data/rasp_data/loc_info_chromosome_Pt.txt", "w") # new
