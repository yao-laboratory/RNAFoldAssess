...
# For testing
exon_locs_raw = {}
ch_1_coord_loc = chromosome_map["chromosome_5"]["coords"]
ch_1_seq_loc = chromosome_map["chromosome_5"]["seq"]
ch_1_json_loc = chromosome_map["chromosome_5"]["json"]
...
f = open(f"/common/yesselmanlab/ewhiting/data/rasp_data/loc_info_chromosome_5.txt", "w") # new
