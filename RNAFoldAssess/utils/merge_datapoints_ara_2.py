...
# For testing
exon_locs_raw = {}
ch_1_coord_loc = chromosome_map["chromosome_2"]["coords"]
ch_1_seq_loc = chromosome_map["chromosome_2"]["seq"]
ch_1_json_loc = chromosome_map["chromosome_2"]["json"]
...
f = open(f"/common/yesselmanlab/ewhiting/data/rasp_data/loc_info_chromosome_2.txt", "w") # new
