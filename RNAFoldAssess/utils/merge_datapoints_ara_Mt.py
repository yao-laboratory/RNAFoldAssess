...
# For testing
exon_locs_raw = {}
ch_1_coord_loc = chromosome_map["chromosome_Mt"]["coords"]
ch_1_seq_loc = chromosome_map["chromosome_Mt"]["seq"]
ch_1_json_loc = chromosome_map["chromosome_Mt"]["json"]
...
f = open(f"/common/yesselmanlab/ewhiting/data/rasp_data/loc_info_chromosome_Mt.txt", "w") # new
