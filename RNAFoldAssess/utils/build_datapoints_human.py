...
def to_datapoint_json(readings, species):
    for k in readings:
        ...
        file_name = f"/common/yesselmanlab/ewhiting/data/rasp_data/human/processed/rasp_{species}_chromosome_{k}.json"
        with open(file_name, "w") as outfile:
            json.dump(data, outfile)


bed_file_loc = "/common/yesselmanlab/ewhiting/data/rasp_data/human/DMS-MaPseq_hg38_Nature_Methods_2017_DMS_invivo_score_both_score_DMSMapSeq_2017.score.bed"
fasta_file = "/common/yesselmanlab/ewhiting/data/rasp_data/human/hg38.fa"
species = "human"
...
to_datapoint_json(readings, species) # Example: {'name': 'chromosome_chrM_number_0', 'sequence': 'CC', 'data': [0.015, 0.013], 'reads': 0}
