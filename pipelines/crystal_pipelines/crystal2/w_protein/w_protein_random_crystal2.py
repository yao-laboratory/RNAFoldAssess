...
# analysis_report_path = f"./w_protein_{predictor_name}_{data_type}_seq20plus_report.txt"
# pipeline_report_path = f"./w_protein_{predictor_name}_{data_type}_seq20plus.txt"
# test_file = f"./w_protein_{predictor_name}_{data_type}_test_file.txt"
