...
analysis_report_path = f"/common/yesselmanlab/ewhiting/reports/{predictor_name}_{data_type}_pipeline_report.txt"
pipeline_report_path = f"/common/yesselmanlab/ewhiting/reports/{predictor_name}_{data_type}_pipeline.txt"
