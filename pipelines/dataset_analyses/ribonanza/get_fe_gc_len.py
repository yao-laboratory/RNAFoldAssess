...
base_dir = "/common/yesselmanlab/ewhiting/reports/ribonanza/analyses"
hi_preds_file = open(f"{base_dir}/Ribo_hi_accuracy_predictions.txt")
lo_preds_file = open(f"{base_dir}/Ribo_lo_accuracy_predictions.txt")
