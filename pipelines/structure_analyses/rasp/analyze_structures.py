...
destination_dir = "/common/yesselmanlab/ewhiting/reports/rasp_data/motif_analysis"
problem_file = open(f"{destination_dir}/problem_file.txt", "w")

data_dir = "/common/yesselmanlab/ewhiting/dataset_analyses/rasp"
good_file = open(f"{data_dir}/RASP_good_guesses.txt")
bad_file = open(f"{data_dir}/RASP_bad_guesses.txt")
