...
destination_dir = "/common/yesselmanlab/ewhiting/reports/ydata/motif_analysis"
problem_file = open(f"{destination_dir}/problem_file.txt", "w")

data_dir = "/common/yesselmanlab/ewhiting/reports/ydata/analyses"
good_file = open(f"{data_dir}/good_guesses_with_energy.txt")
bad_file = open(f"{data_dir}/bad_guesses_with_energy.txt")
