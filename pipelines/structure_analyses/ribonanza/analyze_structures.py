...
destination_dir = "/common/yesselmanlab/ewhiting/reports/ribonanza/motif_analysis"
problem_file = open(f"{destination_dir}/problem_file.txt", "w")

data_dir = "/common/yesselmanlab/ewhiting/reports/ribonanza/analyses"
good_file = open(f"{data_dir}/Ribo_hi_accuracy_predictions.txt")
bad_file = open(f"{data_dir}/Ribo_lo_accuracy_predictions.txt")
