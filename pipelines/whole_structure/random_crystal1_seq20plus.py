...
analysis_report_path = f"/common/yesselmanlab/ewhiting/reports/{predictor_name}_{data_type}_whole_structure_pipeline_report_seq20plus.txt"
pipeline_report_path = f"/common/yesselmanlab/ewhiting/reports/{predictor_name}_{data_type}_whole_structure_pipeline_seq20plus.txt"
