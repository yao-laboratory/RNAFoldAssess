...
dp_file_path = f"{base_dir}/all_pdb_datapoints.txt"
...
with open(f"{base_dir}/pdb_motif_prediction_data.json", "w") as fh:
    json.dump(dp_motif_data, fh)

print(f"Successfully wrote to {base_dir}/pdb_motif_prediction_data.json")
