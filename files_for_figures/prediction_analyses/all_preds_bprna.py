...
bprna_loc = "/work/yesselmanlab/ewhiting/bprna_canonical_reports/acug_preds"
...
headers = "dataset, model, lenience, dp_name, sequence, true_structure, predicted_structure, sensitivity, ppv, f1\n"

for lenience in [0, 1]:
    all_pred_file = open(f"{all_pred_dir}/bprna_master_file_{lenience}.txt", "w")
    all_pred_file.write(headers)
    for m in models:
        pred_path = get_file_loc(m, lenience)
        ...
        for d in data:
            ...
            line = f"bpRNA, {m}, {lenience}, {dp_name}, {seq}, {true_structure}, {pred}, {s}, {p}, {f}\n"
